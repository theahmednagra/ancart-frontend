  ...
  return (
    <div className="flex gap-2 w-full border border-[#02483D] bg-[#02483D] rounded-lg shadow-sm overflow-hidden">
      ...
      <button
        ...
        className={`flex-1 py-3 px-5 rounded-lg font-medium text-white transition-transform ${isOutOfStock ? "bg-gray-300 text-gray-500 cursor-not-allowed" : "bg-[#02483D] hover:scale-103 active:scale-100"}`}
      >
